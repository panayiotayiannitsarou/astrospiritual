...
def generate_report_with_openai(payload: dict) -> str:
    ...
    system_prompt = (
        ...
        "5. ΕΝΟΤΗΤΑ 5 – «Λίγα λόγια για κάθε σπίτι»: γράψε 12 ξεχωριστές, σύντομες παραγράφους, "
        "μία για κάθε οίκο από τον 1ο έως τον 12ο. Σε κάθε παράγραφο να συνοψίζεις με απλή γλώσσα "
        "τι σημαίνει για το άτομο ο συγκεκριμένος οίκος, με βάση όσα προκύπτουν από τα δεδομένα του χάρτη "
        "(ζώδιο ακμής, πλανήτες μέσα στον οίκο, κυβερνήτης και σημαντικές όψεις). Οι παράγραφοι να είναι "
        "συγκεκριμένες, πρακτικές και ενδυναμωτικές, σαν μικρές περιγραφές του πώς βιώνει το άτομο κάθε "
        "περιοχή της ζωής του (εγώ, οικονομικά, επικοινωνία, σπίτι, έρωτας κ.λπ.).\n\n"
...
def main():
    ...
    st.markdown(
        "Για κάθε οίκο (1–12), διάλεξε ποιοι πλανήτες/Χείρωνας/Βόρειος Δεσμός βρίσκονται μέσα σε αυτόν τον οίκο.\n"
